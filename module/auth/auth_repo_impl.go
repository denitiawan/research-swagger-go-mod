...
import (
	"context"
	"database/sql"
	"denitiawan/research-swagger-gomod-gin/common/database"
	"denitiawan/research-swagger-gomod-gin/common/dto"
	baseDto "denitiawan/research-swagger-gomod-gin/common/dto"
...
func (t *AuthRepoImpl) Login(loginDto LoginDto) *dto.ImplResponse {
	function := "Login()"
...
func (t *AuthRepoImpl) FindByUsername(username string) *dto.ImplResponse {
...
func (t *AuthRepoImpl) FindById(id int64) *dto.ImplResponse {
	function := "FindById()"
